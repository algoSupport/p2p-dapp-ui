              ...
              <div className='d-flex flex-stack py-4'>
                <div className='d-flex align-items-center'>
                  ...
                  <div className='ms-5'>
                    ...
                    <div className='fw-bold text-gray-400'>Of course. Thanks so much for ...</div>
                  </div>
                </div>
              ...
              <div className='d-flex flex-stack py-4'>
                <div className='d-flex align-items-center'>
                  ...
                  <div className='ms-5'>
                    ...
                    <div className='fw-bold text-gray-400'>Super simple. Appreciate ...</div>
                  </div>
                </div>

                <div className='d-flex flex-column align-items-end ms-2'>
                  <span className='text-muted fs-7 mb-1'>8 hours</span>
                </div>
              </div>
              ...
              <div className='d-flex flex-stack py-4'>
                <div className='d-flex align-items-center'>
                  ...
                  <div className='ms-5'>
                    ...
                    <div className='fw-bold text-gray-400'>No idea. But it was approved ...</div>
                  </div>
                </div>

                <div className='d-flex flex-column align-items-end ms-2'>
                  <span className='text-muted fs-7 mb-1'>24 hours</span>
                </div>
              </div>
                ...
                <div className='d-flex align-items-center'>
                  ...
                  <div className='ms-5'>
                    ...
                    <div className='fw-bold text-gray-400'>
                      Insane how easy this was. 5 stars ...
                    </div>
                  </div>
                </div>

                <div className='d-flex flex-column align-items-end ms-2'>
                  <span className='text-muted fs-7 mb-1'>2 days</span>
                </div>
              </div>
              ...
              <div className='d-flex flex-stack py-4'>
                <div className='d-flex align-items-center'>
                  ...
                  <div className='ms-5'>
                    ...
                    <div className='fw-bold text-gray-400'>Anytime mate. Please keep doing ...</div>
                  </div>
                </div>
              ...
              <div className='d-flex flex-stack py-4'>
                <div className='d-flex align-items-center'>
                  ...
                  <div className='ms-5'>
                    ...
                    <div className='fw-bold text-gray-400'>
                      Please resend your proof of pay ....
                    </div>
                  </div>
                </div>
              ...
              <div className='d-flex flex-stack py-4'>
                <div className='d-flex align-items-center'>
                  ...
                  <div className='ms-5'>
                    ...
                    <div className='fw-bold text-gray-400'>Release. Thank you very much!</div>
                  </div>
                </div>

                <div className='d-flex flex-column align-items-end ms-2'>
                  <span className='text-muted fs-7 mb-1'>4 days</span>
                </div>
              </div>
            </div>
          </div>
