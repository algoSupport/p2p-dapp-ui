...
const defaultMessages: Array<MessageModel> = [
  {
    user: 4,
    type: 'in',
    text: 'Transaction confirmed. Please check.',
    time: '38 mins',
  },
  {
    user: 2,
    type: 'out',
    text: 'Hey there, thanks for confirming. I have released the escrow.',
    time: '29 mins',
  },
  {
    user: 4,
  ...
  },
  {
    user: 2,
    type: 'out',
    text: 'Please make sure to leave me a positive rating. It helps out a lot!',
    time: '17 mins',
  },
  {
    user: 4,
    type: 'in',
    text: 'Of course. Thanks so much for the swift response. Loved the entire experience. Cilistia is the future!',
    time: '10 mins',
  },
]
